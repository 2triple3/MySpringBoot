...
//
////import com.shanwen.select.interceptor.LoginInteceptor;
//
//@Configuration
...
////                "/static/**", "/file/**", "/wxpay/**", "/chargeArticle/**","/*.txt");
//        registry.addInterceptor(new LoginInterceptor()).addPathPatterns("/**").excludePathPatterns("/admin/login",
//                "/static/**", "/file/**", "/wxapp/**", "/wxpay/**", "/chargeArticle/**","/*.txt");
//    }
//
//
//    @Override
...
//        registry.addResourceHandler("/**.txt").addResourceLocations("file:" + imagePath);
